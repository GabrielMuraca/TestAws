...
WORKDIR /src
COPY ["Aws2.csproj", "Aws2/"]
RUN dotnet restore "Aws2/Aws2.csproj"

WORKDIR "/src/Aws2"
COPY . .
RUN dotnet build "Aws2.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Aws2.csproj" \
